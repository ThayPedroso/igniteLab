                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                src="https://avatars.githubusercontent.com/u/44008476?v=4"
                                alt=""
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Thayla Pedroso</strong>
                                <span className="text-gray-200 text-sm block">A nice girl!</span>
                            </div>
                        </div>
                    </div>
