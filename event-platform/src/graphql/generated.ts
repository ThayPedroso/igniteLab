...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string, title: string, lessonType: LessonType, id: string, availableAt?: any | null }> };
